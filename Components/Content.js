        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-md-7">
            ...
            <div className="info-detail">
              ...
              <p>
                Văn bản giới thiệu về sứ mệnh hay chi chi đó về hội thảo, nói
                chung dài dài một tí :v chi tiết kiểu bla bla để trả lời cho các
                vấn đề phát sinh ở trên còn ở bên trái là poster của hội thảo
                này
              </p>
            </div>
          </div>
